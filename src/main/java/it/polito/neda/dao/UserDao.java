...
public class UserDao {
	...
	public UserBean findUserByMacAddress(String deviceMacAdress) {
		...
		Query query=session.createQuery("from users where deviceMacAdress=:deviceMacAdress");
		query.setString("deviceMacAdress", deviceMacAdress);
